...
Queue System setups a K8s cluster inside an AWS EC2 instance with MicroK8s and uses `Nginx Ingress Controller` and `MetalLB` (Load-Balancer) to expose Queue System service to the outside world.
